...
public class FilteredDemagnetizationCoilContainerScreen extends BaseDemagnetizationCoilContainerScreen<FilteredDemagnetizationCoilContainer> {
    ...
    protected void drawToolTips(MatrixStack matrixStack, DemagnetizationCoilTile tile, int mouseX, int mouseY){
        ...
        if(this.whitelistButton.isHovered())
            this.renderToolTip(matrixStack, true, "gui.advancedmagnet.whitelist." + (tile.filterWhitelist ? "on" : "off"), mouseX, mouseY);
        if(this.durabilityButton.isHovered())
            this.renderToolTip(matrixStack, true, "gui.simplemagnets.demagnetization_coil.durability." + (tile.filterDurability ? "on" : "off"), mouseX, mouseY);
    }
    ...
    protected void drawText(MatrixStack matrixStack, DemagnetizationCoilTile tile){
        ...
        this.drawString(matrixStack, new TranslationTextComponent("gui.advancedmagnet.filter"), 8, 78);
    }
}
