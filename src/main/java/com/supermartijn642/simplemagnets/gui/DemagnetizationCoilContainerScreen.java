...
public class DemagnetizationCoilContainerScreen extends BaseDemagnetizationCoilContainerScreen<DemagnetizationCoilContainer> {
    ...
    @Override
    protected void drawToolTips(MatrixStack matrixStack, DemagnetizationCoilTile tile, int mouseX, int mouseY){
        if(this.upXButton.isHovered() || this.upYButton.isHovered() || this.upZButton.isHovered())
            this.renderToolTip(matrixStack, true, "gui.simplemagnets.demagnetization_coil.range.increase", mouseX, mouseY);
        if(this.downXButton.isHovered() || this.downYButton.isHovered() || this.downZButton.isHovered())
            this.renderToolTip(matrixStack, true, "gui.simplemagnets.demagnetization_coil.range.decrease", mouseX, mouseY);
    }
    ...
    @Override
    protected void drawText(MatrixStack matrixStack, DemagnetizationCoilTile tile){
        ...
        this.drawCenteredString(matrixStack, new StringTextComponent("x:"), 19, 51);
        this.drawCenteredString(matrixStack, new StringTextComponent("" + tile.rangeX), 33, 52);
        this.drawCenteredString(matrixStack, new StringTextComponent("y:"), 72, 51);
        this.drawCenteredString(matrixStack, new StringTextComponent("" + tile.rangeY), 86, 52);
        this.drawCenteredString(matrixStack, new StringTextComponent("z:"), 125, 51);
        this.drawCenteredString(matrixStack, new StringTextComponent("" + tile.rangeZ), 139, 52);
    }
}
