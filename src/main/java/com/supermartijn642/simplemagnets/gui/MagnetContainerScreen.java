...
public class MagnetContainerScreen extends GuiContainer {
    ...
    public void initGui(){
        ...
        this.leftItemButton = this.addButton(new ArrowButton(1, this.guiLeft + 45, this.guiTop + 39, true, () -> SimpleMagnets.channel.sendToServer(new PacketDecreaseItemRange())));

        this.rightItemButton = this.addButton(new ArrowButton(2, this.guiLeft + 78, this.guiTop + 39, false, () -> SimpleMagnets.channel.sendToServer(new PacketIncreaseItemRange())));
        ...
        this.leftXpButton = this.addButton(new ArrowButton(4, this.guiLeft + 139, this.guiTop + 39, true, () -> SimpleMagnets.channel.sendToServer(new PacketDecreaseXpRange())));

        this.rightXpButton = this.addButton(new ArrowButton(5, this.guiLeft + 172, this.guiTop + 39, false, () -> SimpleMagnets.channel.sendToServer(new PacketIncreaseXpRange())));

        this.whitelistButton = this.addButton(new WhitelistButton(6, this.guiLeft + 175, this.guiTop + 78, () -> SimpleMagnets.channel.sendToServer(new PacketToggleWhitelist())));
